...
fig_gdp_lifeExpect = px.scatter(data_frame=data_regions,
                                x=f"{feature1}",
                                y=f"{feature2}",
                                size=data_regions["Ladder score"] - 2,
                                color="Regional indicator",
                                hover_name="Country name",
                                symbol="Regional indicator",
                                size_max=10,
...
color_mapping = {
    'Middle East and Northern Africa': 'blue',
    ...
    'Central and Eastern Europe': 'magenta',
    'Sub-Saharan Africa': 'brown'

}

data_bar['Color'] = data_bar['Regional indicator'].map(color_mapping)
fig_ladderByCountry = px.bar(data_frame=data_bar, x=feature1, y='Country name', orientation='h',
                             title=f'{feature1} by country', template='ggplot2')
...
fig_ladderByCountry.update_traces(marker=dict(color=data_bar['Color']))
